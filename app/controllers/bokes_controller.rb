class BokesController < ApplicationController
  ...
  def index
    ...
    @result = `python3 https://junjunwork.herokuapp.com/app/controllers/sc2.py`
    ...
    @result = `python3 https://junjunwork.herokuapp.com/app/controllers/sc3.py`
  ...
  def show
    ...
    @img_url = Boke.all.order(id: "DESC")
  end
